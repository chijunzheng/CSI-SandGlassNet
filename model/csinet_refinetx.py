# Note: diff csinet.py and csinet_refinetx.py to see changes to refinenet
...
class CsiNet_RefineTX(nn.Module):
    def __init__(self, M=512, Nc=32, Nt=32):
        super(CsiNet_RefineTX, self).__init__()
        ...
        self.refinetx = RefineTX(patch_size=4, ifm=2, d_model=64, nhead=4, ffn_ratio=4, n_block=3)
        ...
        self.final_conv = nn.ConvTranspose2d(in_channels=64, out_channels=2, kernel_size=4, stride=4) 
